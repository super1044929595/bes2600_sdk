...
#define speech_fir_calib_get_delay CONSTRUCT_FUNC_NAME(speech, FIR_CALIB_IMPL, get_delay)
#define speech_fir_calib_get_required_mips CONSTRUCT_FUNC_NAME(speech, FIR_CALIB_IMPL, get_required_mips)
