        ...
        uint8_t bitReverseFlag)
{
  ...
  case 128:
  case 1024:
#if defined(ARM_ALL_FFT_TABLES) || defined(ARM_TABLE_TWIDDLECOEF_F32_16) || defined(ARM_TABLE_TWIDDLECOEF_F32_128) || defined(ARM_TABLE_TWIDDLECOEF_F32_1024)
  ...
  case 256:
  case 2048:
#if defined(ARM_ALL_FFT_TABLES) || defined(ARM_TABLE_TWIDDLECOEF_F32_32) || defined(ARM_TABLE_TWIDDLECOEF_F32_256) || defined(ARM_TABLE_TWIDDLECOEF_F32_2048)
  ...
  case 512:
  case 4096:
#if defined(ARM_ALL_FFT_TABLES) || defined(ARM_TABLE_TWIDDLECOEF_F32_64) || defined(ARM_TABLE_TWIDDLECOEF_F32_512) || defined(ARM_TABLE_TWIDDLECOEF_F32_4096)
