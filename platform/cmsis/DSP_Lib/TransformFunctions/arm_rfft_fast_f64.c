        ...
        float64_t * pOut)
{
   ...
   *pOut++ = (float64_t)0.5 * ( t1a - t1b );
   ...
   do
   {
      ...
      *pOut++ = (float64_t)0.5 * (xAR + xBR + p0 + p3 ); //xAR
      *pOut++ = (float64_t)0.5 * (xAI - xBI + p1 - p2 ); //xAI
        ...
        float64_t * pOut)
{
   ...
   *pOut++ = (float64_t)0.5 * ( xAR - xAI );
   ...
   while (k > 0U)
   {
      ...
      *pOut++ = (float64_t)0.5 * (xAR + xBR - r - s ); //xAR
      *pOut++ = (float64_t)0.5 * (xAI - xBI + t - u ); //xAI
